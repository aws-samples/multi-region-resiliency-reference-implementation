...
package app.settlement.egress.dao;
...
public class NackMessageDAO {
    ...
    public void save(NackMessage nackMessage) throws DynamoDBConnectionException {
        try{
            nackMessageDynamoDbTable.putItem(nackMessage);
        }catch (Exception e){
    ...
    public void save(List<NackMessage> nackMessages) throws DynamoDBConnectionException {
        for (NackMessage m : nackMessages){
            try {
            ...
            {
                log.error("Exception saving nacks to dynamodb", e);
                throw new DynamoDBConnectionException("Error saving nack to dynamodb", e);
            }
