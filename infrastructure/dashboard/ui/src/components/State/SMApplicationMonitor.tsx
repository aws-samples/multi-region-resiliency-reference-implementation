...
const SMApplicationMonitor: FunctionComponent = () => {
    ...
    const getAllRequests = async () => {
        ...
        try {
            ...
            getAppReady("settlement").then(
                (result: IAppReady) => {
                    console.log("Received Result for getAppReady for Settlement:" + JSON.stringify(result))
                    setAppReady(result);
                });

            getAppHealth().then(
                (result: IAppHealth) => {
                    console.log("Received Result for getAppHealth for Settlement:" + JSON.stringify(result))
                    setAppHealth(result);
                });

            getAppReplication("settlement").then(
                (result: IAppReplication) => {
                    console.log("Received Result for getAppReplication for Settlement:" + JSON.stringify(result))
                        ...
                        <div className="custom-home-main-content-area col-xxs-10 offset-xxs-1 col-s-6 col-l-5 offset-l-2 col-xl-6">
                            ...
                            <Container headingVariant='h4'>
                                <Grid container spacing={3} className="spacing_10">
                                    ...
                                    <Grid container  xs={12} className="border_black spacing_10">
                                        <Grid xs={2} spacing={5} className="spacing_10">
                                            <div className="right"><b>Ready</b></div>
                                        </Grid>
                                        <Grid xs={1} spacing={5} className="spacing_10">
                                            <div className="center">{renderReady(appReady.summary)}</div>
                                        </Grid>
                                        <Grid xs={2} spacing={5} className="spacing_10">
                                            <div className="right"><b>Healthy</b></div>
                                        </Grid>
                                        <Grid xs={1} spacing={5} className="spacing_10">
                                            <div className="center">{renderHealth(appHealth.summary)}</div>
                                        </Grid>
                                        <Grid xs={2} spacing={5} className="spacing_10">
                                            <div className="right"><b>Replication</b></div>
                                        </Grid>
                                        <Grid xs={1} spacing={5} className="spacing_10">
                                            <div className="center">{renderReplication(appReplication.summary)}</div>
                                        </Grid>
                                        <Grid item xs={3} spacing={5} className="center spacing_10)">
...
export default SMApplicationMonitor;
