...
const TMApplicationMonitor: FunctionComponent = () => {
    ...
    const renderHealth = (health: any) => {
        return (health == "HEALTHY"?<StatusIndicator statusType="positive"/>:(health == "NOT_HEALTHY"?<StatusIndicator statusType="negative"/>:"?"));
    }

    const renderReplication = (replication: any) => {
        return (replication == "HEALTHY"?<StatusIndicator statusType="positive"/>:(replication == "NOT_HEALTHY"?<StatusIndicator statusType="negative"/>:"?"));
    }
...
export default TMApplicationMonitor;
